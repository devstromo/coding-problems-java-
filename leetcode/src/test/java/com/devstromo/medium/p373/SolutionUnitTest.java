...
class SolutionUnitTest {
    ...
    @Test
    void testKSmallestPairsBest() {
        assertEquals(List.of(List.of(1, 2), List.of(1, 4), List.of(1, 6)), solution.kSmallestPairsBest(new int[]{1, 7, 11}, new int[]{2, 4, 6}, 3));
        assertEquals(List.of(List.of(1, 1), List.of(1, 1)), solution.kSmallestPairsBest(new int[]{1, 1, 2}, new int[]{1, 2, 3}, 2));
