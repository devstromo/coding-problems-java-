...
class SolutionUnitTest {
    ...
    @Test
    void testFindMiddleIndexBest() {
        assertEquals(3, solution.findMiddleIndexLinear(new int[]{2, 3, -1, 8, 4}));
        assertEquals(2, solution.findMiddleIndexLinear(new int[]{1, -1, 4}));
        assertEquals(-1, solution.findMiddleIndexLinear(new int[]{2, 5}));
    }
